...
pub const helper_version = "0.8.3";
pub const capabilities: []const []const u8 = &.{
    ...
    "display_preview_feature_policy_v1", "protected_collection_apply_v1", "collection_preconditions_v2", "display_declaration_mutations_v1",
};
...
pub const fields = [_]Field{
    ...
    b("layout.options.scrolling.open_new_windows_to_right", .layouts, "Open new windows to the right", "Insert new columns immediately after the focused column; overrides portrait stacking.", .layout, "layout.options.scrolling", "open_new_windows_to_right", false),
    ...
    b("input.mouse_follows_focus", .input, "Move pointer with focus", "Move the pointer into newly focused windows, including keyboard and wheel bindings. Hover and click focus do not move it. Output navigation still moves the pointer when disabled.", .input, "input", "mouse_follows_focus", false),
    ...
    k("window_switcher_next", ""),
    k("window_switcher_previous", ""),
    k("window_switcher_dismiss", ""),
    ...
    k("wheel_scroll_left", "Super+WheelUp"),
    k("wheel_scroll_right", "Super+WheelDown"),
    k("wheel_scroll_up", "Alt+Meta+WheelUp"),
    k("wheel_scroll_down", "Alt+Meta+WheelDown"),
