...
with tempfile.TemporaryDirectory(prefix='aqueous-backend-equivalence-') as tmp:
    ...
    additions = {'display_configuration', 'display_declarations', 'candidate_review', 'collection_identity', 'display_model', 'display_observation', 'candidate_impact', 'collection_schema', 'collection_preconditions'}
