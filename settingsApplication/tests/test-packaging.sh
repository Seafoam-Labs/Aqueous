...
for file in bin/aqueous-config bin/aqueousctl share/licenses/aqueous-config/GPL-3.0-only.txt share/doc/aqueous-config/HELPER.md share/doc/aqueous-config/PROTECTED_COLLECTIONS.md share/doc/aqueous-config/aqueous-config-additions-v1.schema.json; do
