...
with tempfile.TemporaryDirectory(prefix='aqueous-retirement-') as tmp:
    ...
    print('binary: compatibility CLI staged and executable')
    for name in ['noctalia','gentoo']:
        ...
        print(name+': embedded application staged, compatibility CLI present, retired plugin assets absent')
