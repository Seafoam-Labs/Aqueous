...
const defaults = [_]struct { []const u8, []const u8 }{
    ...
    .{ "window_switcher_next", "" },                           .{ "window_switcher_previous", "" },
    .{ "window_switcher_dismiss", "" },                        .{ "close_focused", "Super+Q" },
    ...
    .{ "scroll_viewport_right_arrow", "Super+Right" },         .{ "scroll_viewport_up", "Super+Up" },
    .{ "scroll_viewport_down", "Super+Down" },                 .{ "consume_window_into_column", "Super+Ctrl+J" },
    ...
    .{ "move_to_output_right", "Super+Shift+Period" },         .{ "rotate_output_clockwise", "Super+Ctrl+R" },
