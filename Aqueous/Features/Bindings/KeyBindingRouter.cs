...
internal sealed class KeyBindingRouter : IKeyBindingRouter
{
    ...
    private static readonly IReadOnlyDictionary<KeyBindingAction, Action<KeyBindingRouter>> ActionTable =
        new Dictionary<KeyBindingAction, Action<KeyBindingRouter>>
        {
            ...
            [KeyBindingAction.FocusOutputLeft]       = c => c._workspaceService.FocusOutput(-1),
            [KeyBindingAction.FocusOutputRight]      = c => c._workspaceService.FocusOutput(+1),
            [KeyBindingAction.MoveToOutputLeft]      = c => c._workspaceService.MoveFocusedToOutput(-1),
            [KeyBindingAction.MoveToOutputRight]     = c => c._workspaceService.MoveFocusedToOutput(+1),
