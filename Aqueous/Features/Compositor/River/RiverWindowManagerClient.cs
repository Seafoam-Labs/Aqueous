    ...
    private void HandleKeyBindingAction(KeyBindingAction action)
    {
        switch (action)
        {
            ...
            case KeyBindingAction.ToggleFullscreen:
                if (_focusedWindow != IntPtr.Zero)
                {
                    _windowState.ToggleFullscreen(_focusedWindow);
                }
                else
                {
                    Log("toggle_fullscreen: no focused window");
                }
            ...
            case KeyBindingAction.ToggleMaximize:
                if (_focusedWindow != IntPtr.Zero)
                {
                    _windowState.ToggleMaximize(_focusedWindow);
                }
                else
                {
                    Log("toggle_maximize: no focused window");
                }
            ...
            case KeyBindingAction.ToggleFloating:
                if (_focusedWindow != IntPtr.Zero)
                {
                    _windowState.ToggleFloating(_focusedWindow);
                }
                else
                {
                    Log("toggle_floating: no focused window");
                }
            ...
            case KeyBindingAction.ToggleMinimize:
                if (_focusedWindow != IntPtr.Zero)
                {
                    _windowState.ToggleMinimize(_focusedWindow);
                }
                else
                {
                    Log("toggle_minimize: no focused window");
                }
