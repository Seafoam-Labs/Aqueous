...
for key in (
    ...
    "typography.state.partial",
    "typography.face.automatic",
    "status.typography_applied",
    "stacking.normalize",
    "snap_zone.title",
    "snap_layout.title",
    "snap_layout.bind_zone",
    "keybind.add_layout",
    "rule.window_rules",
...
for feature in (
    ...
    'desktop.font.family',
    'desktop.font.style',
    'local function fontFamilyControl',
    ...
    'preferredSnapZoneCommand',
    'builtin:set_snap_layout:',
    'builtin:cycle_snap_layout',
    'MAX_SNAP_LAYOUTS = 8',
    'MAX_SNAP_ZONES = 16',
    'window_rule_changes',
    'normalize_stacking',
...
assert catalog["plugin"][0]["version"] == "0.4.1"
