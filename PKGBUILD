...
license=('GPL3')
depends=('gtk4' 'socat' 'grim' 'slurp' 'wl-clipboard' 'cliphist' 'brightnessctl' 'bluez' 'bluez-utils' 'libastal-io' 'libastal-apps' 'libastal-auth' 'libastal-battery' 'libastal-bluetooth' 'libastal-cava' 'libastal-greet' 'libastal-mpris' 'libastal-network' 'libastal-notifd' 'libastal-powerprofiles' 'libastal-tray' 'libastal-wireplumber')
